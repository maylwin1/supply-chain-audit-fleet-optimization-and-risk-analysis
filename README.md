...
Equipment Damage: These older units are directly responsible for a $740k annual equipment damage bill.
...
At-Fault vs. Not-At-Fault: 65% of total costs ($1.73M) are "False" (not driver-at-fault), suggesting mechanical or third-party issues.
...
🚀 Recommendations
Modernize Asset Base: Phased retirement of the 2015 model-year fleet to reduce the $740k equipment damage drain.

Strategic Maintenance: Deploy targeted inspections in high-risk "Hot Zones" (Southeast) to prevent costly DOT violations.

KPI Shift: Transition driver metrics from "Miles Driven" to "OTD Accuracy" to improve the 55.7% reliability rating.
